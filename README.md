...
- **Public surface synced to the live repo** — metadata, catalog counts, plugin manifests, and install-facing docs now match the actual OSS surface: 60 agents, 231 skills, and 83 legacy command shims.
...
**That's it!** You now have access to 60 agents, 231 skills, and 83 legacy command shims.
...
| Commands | PASS: 83 commands | PASS: 35 commands | **Claude Code leads** |
...
| **Commands** | 83 | Shared | Instruction-based | 35 | 6 prompts |
