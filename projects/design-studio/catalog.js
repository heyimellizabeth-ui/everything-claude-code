/* Generated by scripts/studio/analyze-styles.js — 2026-05-18 */
window.CATALOG = {
  ...
  "elements": [
    ...
    },
    {
      ...
      "description": "Colors extracted from foodking-fast-food-restaurant: #777777, #f2f2f2, #999999, #111111, #333333",
      "source": "foodking-fast-food-restaurant",
      "tags": [
        "palette",
        "colors"
      ],
      "previewHtml": "<!DOCTYPE html><html><head><style>*{margin:0;padding:0;box-sizing:border-box}body{background:#111;padding:20px;font-family:'Courier New',monospace;min-height:180px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px}</style></head><body><div style=\"display:flex;gap:8px;flex-wrap:wrap;justify-content:center\"><div style=\"width:40px;height:40px;background:#777777;flex-shrink:0;border-radius:2px\"></div><div style=\"width:40px;height:40px;background:#f2f2f2;flex-shrink:0;border-radius:2px\"></div><div style=\"width:40px;height:40px;background:#999999;flex-shrink:0;border-radius:2px\"></div><div style=\"width:40px;height:40px;background:#111111;flex-shrink:0;border-radius:2px\"></div><div style=\"width:40px;height:40px;background:#333333;flex-shrink:0;border-radius:2px\"></div><div style=\"width:40px;height:40px;background:#ffffff;flex-shrink:0;border-radius:2px\"></div></div><div style=\"font-size:10px;letter-spacing:2px;color:#666\">#777777  #f2f2f2  #999999  #111111  #333333  #ffffff</div></body></html>",
      "snippet": ":root {\n  --color-1: #777777;\n  --color-2: #f2f2f2;\n  --color-3: #999999;\n  --color-4: #111111;\n  --color-5: #333333;\n  --color-6: #ffffff;\n}"
    },
    {
      "id": "foodking-fast-food-restaurant-typography",
      "category": "typography",
      "name": "foodking-fast-food-restaurant — Typography",
      "description": "Fonts used: sans-serif, Helvetica Neue, inherit",
      "source": "foodking-fast-food-restaurant",
      "tags": [
        "typography",
        "font"
