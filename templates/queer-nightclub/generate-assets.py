...
og_code = ask_claude_for_pillow_code(
    f"A 1200×630 px social media preview card for '{{SITE_NAME}}', a queer nightclub in {{VENUE_CITY}}. "
    ...
    f"Even smaller text 'ALKMAAR · EST. {{SITE_EST}} · CLUB{{SITE_SHORT}}.NL' centered below that (~13 px, opacity 35%). "
